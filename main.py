...
# Servindo arquivos estáticos (como a logo)
...
def simular_estado(empresa: EmpresaInput, estado: str):
    # Simulação simples com valores fictícios
    if estado == "SP":
        carga = 13.5
    elif estado == "MG":
        carga = 14.2
...
async def analisar_dados(empresa: EmpresaInput):
    ...
    for estado in empresa.estados_simulacao:
        resultado = simular_estado(empresa, estado)
    ...
    regimes = [
        {
            ...
            "carga": 11.0,
            "justificativa": "Alíquota reduzida para empresas com faturamento até R$ 4,8 milhões."
        },
        {
            "nome": "Lucro Presumido",
            "carga": 15.5,
            "justificativa": "Boa opção com margem operacional alta e baixo custo."
        },
        {
            "nome": "Lucro Real",
            "carga": 18.2,
            "justificativa": "Mais vantajoso para empresas com prejuízo fiscal ou margens pequenas."
        }
    ]
